...
public class Adminlist extends JFrame {
	...
	public Adminlist() {
		...
		String[] columnname= {"AdminId", "Username", "Mobile Number"};
		...
		lblAdminList.setFont(new Font("Tahoma", Font.BOLD, 28));
		lblAdminList.setBounds(360, 23, 236, 40);
		getContentPane().add(lblAdminList);
		...
		btnLogout.setBounds(757, 15, 136, 55);
